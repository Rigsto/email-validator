...
import com.xtmd.emailvalidator.result.reason.ExpectingDTEXT;
import com.xtmd.emailvalidator.result.reason.UnusualElements;
...
public class DomainLiteral extends PartParser {
    ...
    public Result parse() {
        ...
        if (!ipv6Tag) {
            this.warnings.add(new com.xtmd.emailvalidator.warning.DomainLiteral());
            return new ValidEmail();
        }
